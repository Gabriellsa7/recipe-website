          ...
          >
            ...
            >
              ...
              <Bottom className="flex flex-col gap-5 items-start mx-6 my-4 pb-4 justify-around min-[768px]:min-h-[200px]">
                ...
                <p className="font-medium text-lg text-slate-900 min-[320px]:max-w-[100px] min-[320px]:truncate min-[768px]:max-w-[200px] min-[768px]:truncate min-[768px]:overflow-hidden min-[1024px]:min-w-[500px]">
